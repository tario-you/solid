...
for i in range(3, 10):
    ...
    iteration = "2025-03-26-" + llm_model + f'_{i}'
    ...
    rerun_llm, rerun_opt, rerun_coord = True, True, True
    graph_indiv = True
    ...
    # get_closing_prices(data_loaded) # TODO
    ...
    # portfolio = get_stock_price(tickers, start_date, end_date) # TODO
    # portfolio.to_csv(pft_path, index=True) # TODO
    ...
    initial_stock_info = generate_data_summary(stock_reports)  # TODO
    ...
    # demonstration of the data being got # TODO
    portfolio = pd.read_csv(pft_path, parse_dates=["Date"], index_col="Date")
    # start_date = datetime.datetime(2023, 12, 1)
    # end_date = datetime.datetime(
    #     2023, 12, get_last_trading_day_of_month(2023, 12))
    ...
    class CoordinationFramework():
        ...
        def update_plan(self, plan1, price1, plan2, price2):
            ...
            for p1, p2, pr1, pr2 in zip(plan1, plan2, price1, price2):
                ...
                result.append(
                    max(0, average_price / self.penalty + average_plan))
            return result
        ...
        def LLMAlgorithm(self, data, verbose=False):
            ...
            for month, month_data in enumerate(data):
                ...
                self.LLM_plan = self.LLM_Agent(
                    month_data, self.current_plan, month, 0,  pure=True, verbose=verbose)
